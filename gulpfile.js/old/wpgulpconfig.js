...
module.exports = {
  ...
  , chunks: { // Chunks are arrays of paths or globs matching a set of source files; this way you can organize a bunch of scripts that go together into pieces that can then be bundled (above)
    ...
    , pageloader: [
      ...
      , src+'js/page-loader.js'
       ...
       src + 'js/plugins/affix.js';
       src + 'js/plugins/collapse.js';
       src + 'js/plugins/instafeed.min.js';
       src + 'js/plugins/jquery.form-validator.min.js';
       src + 'js/plugins/jquery.lazyload.js';
       src + 'js/plugins/jquery.scrollstop.js';
       src + 'js/plugins/moment.min.js';
       src + 'js/plugins/owl.carousel.min.js';
       src + 'js/plugins/scrollspy.js';
       src + 'js/plugins/slick.min.js';
       src + 'js/plugins/sr.js';
       src + 'js/script.js';
      ]*/
      core: [
            src + 'js/vendors/jquery.min.js',
  ...
  , php: {
    ...
    styles: {
      src: src+'styles/**/*' // This simply copies PHP files over; both this and the previous task could be combined if you like
      , dest: build+'styles'
    },
    imgs: {
      src: src+'imgs/**/*' // This simply copies PHP files over; both this and the previous task could be combined if you like
      , dest: build+'imgs'
    },
    fonts: {
